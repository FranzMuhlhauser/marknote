...
export function MenuBar(props: MenuBarProps) {
  ...
  const ver: MenuAction[] = [
    ...
    { separator: true, label: '' },
    { label: props.focusMode ? 'Salir Modo Enfoque' : 'Modo Enfoque', shortcut: 'F11', action: props.onFocusMode },
    { label: 'Pantalla Completa', action: props.onFullscreen },
    { separator: true, label: '' },
  ...
  const ayuda: MenuAction[] = [
    ...
    { label: 'Novedades de esta versión', action: props.onShowWhatsNew }
  ]
